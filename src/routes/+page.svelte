<script lang="ts">
    ...
    const shuffledItems = data.post.items.sort(() => 0.5 - Math.random());
...
<article class="grid md:grid-cols-4 gap-4 border-t border-slate-700/40 pt-5">
    {#each randomItems as items, i}
